...
import { ChevronDown, Boxes, RefreshCw, Search, ArrowUpDown } from 'lucide-react';
...
// Status configuration for nodes
...
export function NodesPanel({ nodes, configs, onRefresh, isLoading = false }: NodesPanelProps) {
  const [isOpen, setIsOpen] = useState(() => {
    const saved = localStorage.getItem('nodesPanel-open');
    return saved !== 'false';
  });
  ...
  useEffect(() => {
    localStorage.setItem('nodesPanel-open', String(isOpen));
  }, [isOpen]);
  ...
  const filters: { value: NodeFilter; label: string }[] = [
    { value: 'all', label: 'All' },
            ...
            <div className="flex items-center justify-between">
              <CollapsibleTrigger asChild>
                <button className="flex items-center gap-2 hover:opacity-80 transition-opacity">
                  ...
                  <CardTitle>Blockchain Nodes</CardTitle>
            ...
            <div className="p-4 border-b flex gap-4 flex-wrap items-center">
              <div className="relative flex-1 min-w-50">
                ...
                <Input
                  ...
                  placeholder="Search nodes by name or server..."
                  className="pl-9"
                />
              </div>
            ...
            <CardContent className="p-0">
              {isLoading ? (
                ...
                <div className="p-8 text-center text-muted-foreground">
                  ...
                  <p className="font-medium">No blockchain nodes found</p>
